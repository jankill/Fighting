...
<div class="container">
    <fieldset>
    <form:form modelAttribute="postForm"  enctype="multipart/form-data" class="form-horizontal" role="form" action="addPost" method="post">
        <div class="row">
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <form:textarea path="postContent" class="form-control" rows="3" id="TextareaContent"></form:textarea>
                </div>
            </div>
        </div>
